  ...
  return (
    <div className="about-me-section dp-section">
      ...
      <p className="dp-section--text">
        ...
        a little bit farther when you're with the right people. I enjoy
      ...
      <p className="dp-section--text">
        ...
        important to spend time outdoors being active. I rock climb extensivley,
        sometimes up to 5 times a week. I share this passion with two friends
        who I constantly entrust my life too.
      </p>
    </div>
  );
}
